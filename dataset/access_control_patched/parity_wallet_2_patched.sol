...
abstract contract WalletAbi {
  ...
  function hasConfirmed(bytes32 _operation, address _owner) view virtual external returns (bool);
  ...
  function confirm(bytes32 _h) virtual external returns (bool o_success);
}
...
contract WalletLibrary is WalletEvents {
  ...
  modifier only_uninitialized { if (initialized || m_numOwners > 0) throw; _; }
