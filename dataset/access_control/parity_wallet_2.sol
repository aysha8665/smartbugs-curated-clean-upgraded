...
contract WalletAbi {
  ...
  function execute(address _to, uint _value, bytes memory _data) external returns (bytes32 o_hash);
...
contract WalletLibrary is WalletEvents {
  ...
  function initMultiowned(address[] _owners, uint _required) only_uninitialized public {
  ...
  // ======================
  function initWallet(address[] _owners, uint _required, uint _daylimit) only_uninitialized public {
