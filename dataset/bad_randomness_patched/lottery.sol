 ...
 */
 ...
 contract Lottery {
     ...
     function makeBet() public payable {
         ...
         // Use commit-reveal or oracle for randomness
         // block.number is predictable by miners
         bool won = (uint256(keccak256(abi.encodePacked(block.prevrandao, msg.sender, block.timestamp))) % 2) == 0;
